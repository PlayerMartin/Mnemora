...
const CompletionScreen = memo(
  ({ stats, skippedCount, onSelectFolder, onLoopBack }: CompletionScreenProps) => {
    return (
      <div className="completion-screen">
        ...
        <div className="completion-stats">
          <div className="stat-group">
            ...
            <ul>
              <li>
                Files Sorted: <strong>{stats.movedCount}</strong>
              </li>
              <li>
                Files Deleted: <strong>{stats.deletedCount}</strong>
              </li>
              <li>
                Files Skipped: <strong>{skippedCount}</strong>
              </li>
            </ul>
          </div>
